...
class MaskRCNN():
    ...
    def __init__(self, mode, config, model_dir, session=None):
        """
    ...
    def experimental_train(self, train_dataset, val_dataset, learning_rate, epochs, layers, augmentation = None, custom_callbacks = None, no_augmentation_sources = None):
        ...
        for i in range(epochs*1000):
            ...
            hasil = self.keras_model.fit(x=x_train, y=y_train, validation_data=(x_val, y_val), verbose=0)
            print('result ' + str(i))
            print(hasil.history.items())
            # t.update(1)
    ...
    def train(self, train_dataset, val_dataset, learning_rate, epochs, layers, 
        ...
        callbacks = [
            ...
            keras.callbacks.EarlyStopping(monitor='loss', patience=5, verbose=1, restore_best_weights=True, mode='min')
        ]
